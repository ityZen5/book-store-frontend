            ...
            <div className="flex mt-12 h-full flex-col overflow-hidden bg-white shadow-xl">
                ...
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                    ...
                    <div className="mt-6">
                        <Link
                            to="/checkout"
                            className="flex items-center justify-center rounded-md border border-transparent bg-green-500 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-green-700"
                        >
                            Checkout
                        </Link>
                    </div>
