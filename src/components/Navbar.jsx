                                            ...
                                            <ul className='space-y-2 p-4'>
                                                {
                                                    navigation.map((item) => (
                                                        <li key={item.name} onClick={() => setIsDropdownOpen(false)}>
                                                            <Link to={item.href} className='block text-gray-700 hover:bg-gray-100 px-2 py-1 rounded'>
                                                                {item.name}
                                                            </Link>
                                                        </li>
                                                    ))
                                                ...
                                                <li>
                                                    ...
                                                    className='block w-full text-left text-gray-700 hover:bg-gray-100 px-2 py-1 rounded'>Logout</button>
                                                </li>
                                            </ul>
                                        </div>
                                    )
